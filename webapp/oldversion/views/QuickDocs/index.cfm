...
<table cellpadding="5" width="98%" align="center">
    <tr>
		...
		<form action="" method="get">
			<label for="search" class="search">Search</label><input type="text" size="40" name="item" value="#rc.item#" class="search" id="search">
		</form>
		...
		<!--- lets get the property of the entity
		<cfset ormFlush()>
		<cfset myExample = EntityNew("Example")>
		<cfset props = getMetaData(myExample).properties>
		<cfdump var="#props#">
		 --->
